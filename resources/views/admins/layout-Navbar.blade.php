    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <div class="col-3 mb-4">
                                <a href="{{ route('users.list') }}" class="text-decoration-none">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <div
                                                class="app-icon bg-orange d-flex justify-content-center align-items-center">
                                ...
                                <a href="{{ route('users.list') }}" class="text-decoration-none">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            ...
                                            <h6 class="text-muted mb-0">เพิ่ม ลบ แก้ไข หรือ ให้สิทธิการใช้งานแก่ผู้ใช้
                                            </h6>
                                        </div>
                                    </div>
                                </a>
                ...
                @if (
                    (Auth::user()->permission['adminper_mission'] ?? false) ||
                        (Auth::user()->permission['manage_dashboard'] ?? false) ||
                        (Auth::user()->permission['view_fttx'] ?? false))
                            ...
                            <div class="col-3 mb-4">
                                <a href="{{ route('importdata') }}" class="text-decoration-none">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <div
                                                class="app-icon bg-cyan d-flex justify-content-center align-items-center">
                        ...
                        <div class="col-3 mb-4">
                            <a href="{{ route('user-logs') }}" class="text-decoration-none">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <h5 class="mb-1">ประวัติการทำงาน</h5>
                                        <h6 class="text-muted mb-0">แสดงข้อมูลประวัติทำงาน (Log) ของข้อมูล Dashboard
                                        </h6>
                                    </div>
                                </div>
                            </a>
          ...
          <div class="col-3 mb-4">
            <a href="{{ route('user-logs') }}" class="text-decoration-none">
              <div class="row align-items-center">
                ...
                @if (
                    (Auth::user()->permission['adminper_mission'] ?? false) ||
                        (Auth::user()->permission['manage_banner'] ?? false) ||
                        (Auth::user()->permission['manage_imageevent'] ?? false))
                            ...
                            <div class="col-3 mb-4">
                                <a href="{{ route('edit_banner') }}" class="text-decoration-none">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <div
                                                class="app-icon bg-green d-flex justify-content-center align-items-center">
