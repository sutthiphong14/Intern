    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('requests.createUser', $request->id_request) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="username" value="{{ $request->user_request }}">
            </div>
                ...
                <table id="permissionTable" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="text-start">
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input " type="checkbox" name="form_event" data-group="event">
                                </div>
                            </td>
                        </tr>
