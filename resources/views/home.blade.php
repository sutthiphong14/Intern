            ...
            <div class="slide">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="2500">
                    ...
                    <div class="carousel-item active">
                        <img src="{{ asset('storage/banner_images/ceo_intranet.jpg') }}" alt="Banner 1">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('storage/banner_images/nt_net_ban.jpg') }}" class="d-block w-100 rounded"
                            alt="Banner 2">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('storage/banner_images/nt_sta-66.jpg') }}" class="d-block w-100 rounded"
                            alt="Banner 3">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('storage/banner_images/S__31670320.jpg') }}" class="d-block w-100 rounded"
                            alt="Banner 4">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('storage/banner_images/S__68780184V2.jpg') }}" class="d-block w-100 rounded"
                            alt="Banner 5">
                    </div>
                    ...
                    <tbody class='align-items-center '>
                        @foreach ($data->take(10) as $item1)
                            <tr class=>
                                ...
                                <td class='ms-5 text-center'><a href="{{ $item1->link }}" class="btn btn-warning"
                                        target="_blank">Download <i class="fas fa-arrow-down"></i></a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
