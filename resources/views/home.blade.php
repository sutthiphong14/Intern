            ...
            <tbody>
                <tr>
                    ...
                    <td><a type="submit"
                            ...
                            class="btn btn-dark">Download <i class="fas fa-arrow-down"></i></a></td>
                </tr>
                <tr>
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            <div class="col-12 mb-1">
                <div class="performance p-2 bg-back rounded">
                    ...
                    <ul class="list-unstyled text-dark">
                        <li><i class="fas fa-tag"></i><a href="#" class="text-dark">ผลการดำเนินงาน เดือน ก.ย. 67</a>
                            <span class="right badge badge-danger">New</span>
                        </li>
                        <li><i class="fas fa-tag"></i><a href="#" class="text-dark">สถานภาพกลุ่ม Broadband เดือน ต.ค.
                                67</a> <span class="right badge badge-danger">New</span></li>
                        <li><i class="fas fa-tag"></i><a href="#" class="text-dark">ประสิทธิภาพการจัดเก็บหนี้ เดือน ก.ย.
                                67</a> <span class="right badge badge-danger">New</span></li>
                        <li><i class="fas fa-tag"></i><a href="#" class="text-dark">ความคืบหน้า Digital Transformation
                                เดือน ต.ค. 67</a> <span class="right badge badge-danger">New</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col mb-4">
                <div class="performanceMk p-2 bg-back pb-4 rounded">
                    ...
                    <ul class="list-unstyled text-dark">
                        <li><i class="fas fa-tag"></i><a href="#" class="text-dark">ผลการดำเนินงานกลุ่มบริการ SI เดือน
                                ก.ย. 67</a> <span class="right badge badge-danger">New</span></li>
                        <li><i class="fas fa-tag"></i><a href="#" class="text-dark">ผลการดำเนินงานบริการ ICT Solution
                                เดือน ก.ค. 67</a> <span class="right badge badge-danger">New</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col mb-4">
                <div class="performanceMk p-2 bg-back rounded">
                    ...
                    <ul class="list-unstyled text-dark">
                        <li><i class="fas fa-tag"></i><a href="#" class="text-dark">คุณภาพบริการ Broadband เดือน ก.ย.
                                67</a> <span class="right badge badge-danger">New</span></li>
