...
<link rel="stylesheet" href="{{ asset('dist/assets/vendor/css/pages/page-auth.css') }}" class="template-customizer-theme-css" />
...
<link rel="stylesheet" href="{{ asset('dist/assets/vendor/libs/apex-charts/apex-charts.css') }}" />
    ...
    <script src="{{asset('dist/assets/vendor/js/config.js')}}"></script>
      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              <!-- Logo -->
              <img src="{{ URL::asset('dist/img/ntcolor.png') }}" alt="Logo" class="brand-image text-center mb-3" style="height: 40px;">
              <!-- /Logo -->
              <h2 class="mb-2 text-center">ยินดีต้อนรับเข้าสู่ระบบ</h2>
                ...
                <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    ...
                    <a href="auth-forgot-password-basic.html">
                      <small class = 'warning'>Forgot Password?</small>
                    </a>
                  </div>
