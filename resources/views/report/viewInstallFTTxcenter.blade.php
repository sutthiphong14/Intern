                                    ...
                                    <tbody class="text-center align-middle">
                                        @foreach ($installData as $item)
                                            <tr>
                                                ...
                                                <td
                                                    class="{{ $item['installation_percentage_within_3_days'] > 80 ? 'bg-success' : ($item['installation_percentage_within_3_days'] > 60 ? 'bg-warning' : 'bg-danger') }}">
                                                    {{ $item->installation_percentage_within_3_days }}%</td>
                                            </tr>
                                        @endforeach
