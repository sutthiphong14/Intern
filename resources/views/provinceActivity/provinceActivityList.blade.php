            ...
            <tbody>
                @foreach ($data as $row)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('provinceactivityedit', $row->province_id) }}"
                            ...
                            <a href="{{ route('province.createServiceCenter', $row->province_id) }}"
                                class="btn btn-success btn-sm">เพิ่มศูนย์บริการ</a>
