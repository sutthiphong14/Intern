...
@section('content')
    <div class="container">
        ...
        <div class="mb-3">
            <a href="{{ route('province.createServiceCenter', $province->province_id) }}"
                class="btn btn-primary">เพิ่มศูนย์บริการ</a>
                ...
                @if ($province->centers->count() > 0)
                    @foreach ($province->centers as $center)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('servicecenteractivityedit', $center->center_id) }}"
