...
/* กำหนดความสูงของ modal ให้เล็กลง */
    #editProvinceModal .modal-dialog {
        max-width: 400px;
    ...
    #editProvinceModal .modal-content {
        height: auto;
            ...
            <div class="d-flex justify-content-between align-items-center gap-2">
                ...
                <div class="d-flex align-items-center gap-2">
                    <button class="btn btn-success " data-bs-toggle="modal"
                        data-bs-target="#provinceModal">เพิ่มจังหวัด</button>
                            ...
                            <form id="editProvinceForm" method="POST" action="">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="provinceName" name="province_name"
                                            required>
                                    </div>
                                </div>
                                <div class="modal-footer">
